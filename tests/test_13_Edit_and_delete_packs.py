...
# Test name: t13 Edit and delete packs
import pytest
import time
import json
...
class Test_13_Edit_and_delete_packs:
  ...
  def test_13_Edit_and_delete_packs(self):
    ...
    self.driver.find_element(By.NAME, "cat_id").send_keys("packs13")
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.ID, "south")))
    assert len(self.driver.find_elements(By.CSS_SELECTOR, "a[href*=\"page=configure_edit\"][href*=\"cat_id=packs13\"]")) > 0
    self.driver.execute_script("//SETDESC:Assert category is saved")
    self.driver.find_element(By.XPATH, "//td//span[contains(.,'packs13')]").send_keys("SAVESCREENSHOT")
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"prefix=pack_management\"][href*=\"page=packs\"]").click()
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"page=packs_add\"][href*=\"cat_id=packs13\"]").click()
    self.driver.find_element(By.CSS_SELECTOR, "a[href=\"#multiplepacks\"]").click()
    self.driver.execute_script("fd=new FormData($('form[enctype=\"multipart/form-data\"]')[0]);fd.set('packs_upload',new Blob([decodeURIComponent('id,f_test%0A1,11%0A2,22%0A3,33')]));fetch( window.location.href, {body:fd, method:'post'})")
    self.driver.execute_script("//SAVEDESC:Perform upload of CSV data")
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"prefix=pack_management\"][href*=\"page=packs\"]:not([href*=\"logout\"])").click()
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"page=packs_list\"][href*=\"cat_id=packs13\"]").click()
    assert len(self.driver.find_elements(By.CSS_SELECTOR, "a[href*=\"page=packs_edit\"]")) > 0
    ...
    self.driver.find_element(By.NAME, "f_test").send_keys("1234")
    self.driver.execute_script("$('#south').remove()")
    time.sleep(0.5)
    ...
    self.driver.execute_script("//SETDESC:Assert pack updated")
    self.driver.find_element(By.CSS_SELECTOR, ".mod-packmgmt-okmsg").send_keys("SAVESCREENSHOT")
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"page=packs_list\"][href*=\"cat_id=packs13\"]").click()
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"page=packs_edit\"][href*=\"pack_id=3\"]").click()
    self.driver.find_element(By.CSS_SELECTOR, ".mod-packmgmt-formtable input[type=\"button\"]").click()
    self.driver.execute_script("$('#south').remove()")
    self.driver.find_element(By.CSS_SELECTOR, "[role=\"dialog\"] .ok-button").click()
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.ID, "south")))
    assert len(self.driver.find_elements(By.CSS_SELECTOR, "a[href*=\"page=packs_edit\"][href*=\"pack_id=3\"]")) == 0
    self.driver.execute_script("//SETDESC:Assert pack ID 3 not present")
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"page=packs_edit\"][href*=\"pack_id=2\"]").send_keys("SAVESCREENSHOT")
    ...
    self.driver.find_element(By.ID, "user_role").find_element(By.XPATH, "(descendant::option)[. = 'PackEdit']").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"prefix=pack_management\"][href*=\"page=packs\"]").click()
    assert len(self.driver.find_elements(By.CSS_SELECTOR, "a[href*=\"page=packs_list\"][href*=\"cat_id=packs13\"]")) > 0
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"page=packs_list\"][href*=\"cat_id=packs13\"]").click()
    assert len(self.driver.find_elements(By.CSS_SELECTOR, "a[href*=\"page=packs_edit\"]")) > 0
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"page=packs_edit\"][href*=\"pack_id=2\"]").click()
    assert len(self.driver.find_elements(By.CSS_SELECTOR, "input[name=\"f_test\"][value=\"1234\"]")) > 0
    self.driver.find_element(By.NAME, "f_test").send_keys("22")
    self.driver.execute_script("$('#south').remove()")
    time.sleep(0.5)
    self.driver.find_element(By.CSS_SELECTOR, ".mod-packmgmt-formtable input[type=\"submit\"]").click()
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.ID, "south")))
    ...
    self.driver.find_element(By.CSS_SELECTOR, "[role=\"dialog\"] .ok-button").click()
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.ID, "south")))
    assert len(self.driver.find_elements(By.CSS_SELECTOR, "a[href*=\"page=packs_edit\"][href*=\"pack_id=2\"]")) == 0
    self.driver.execute_script("//SETDESC:Assert pack ID 2 not present")
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"page=packs_edit\"][href*=\"pack_id=1\"]").send_keys("SAVESCREENSHOT")
    ...
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"page=packs_list\"][href*=\"cat_id=packs13\"]").click()
    assert len(self.driver.find_elements(By.CSS_SELECTOR, "a[href*=\"page=packs_edit\"]")) == 0
    self.driver.execute_script("//SETDESC:Assert option to edit pack not present")
    self.driver.find_element(By.CSS_SELECTOR, "input[data-pack-chkbx=\"1\"]").send_keys("SAVESCREENSHOT")
