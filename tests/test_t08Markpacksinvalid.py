...
class TestT08Markpacksinvalid():
  ...
  def test_t08Markpacksinvalid(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, "input[type=\"submit\"]").click()
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.ID, "south")))
    elements = self.driver.find_elements(By.CSS_SELECTOR, "a[href*=\"page=configure_edit\"][href*=\"cat_id=packs8\"]")
    assert len(elements) > 0
    ...
    elements = self.driver.find_elements(By.CSS_SELECTOR, ".packmgmt-packinvalid")
    assert len(elements) > 0
    ...
    dropdown.find_element(By.XPATH, "//option[. = 'PackInvalid']").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"prefix=pack_management\"][href*=\"page=packs\"]").click()
    elements = self.driver.find_elements(By.CSS_SELECTOR, "a[href*=\"page=packs_list\"][href*=\"cat_id=packs8\"]")
    assert len(elements) > 0
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"page=packs_list\"][href*=\"cat_id=packs8\"]").click()
    elements = self.driver.find_elements(By.CSS_SELECTOR, ".packmgmt-packinvalid")
    assert len(elements) > 0
