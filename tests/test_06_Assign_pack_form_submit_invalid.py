...
class Test_06_Assign_pack_form_submit_invalid:
  ...
  def test_06_Assign_pack_form_submit_invalid(self):
    ...
    self.driver.find_element(By.NAME, "cat_id").send_keys("packs6")
    ...
    self.driver.find_element(By.XPATH, "//td//span[contains(.,'packs6')]").send_keys("SAVESCREENSHOT")
    ...
    self.driver.execute_script("//SETDESC:Assert packs marked invalid successfully")
    ...
    self.driver.find_element(By.CSS_SELECTOR, "input[name=\"pack_id\"][value=\"\"]").send_keys("SAVESCREENSHOT")
    ...
    self.driver.find_element(By.CSS_SELECTOR, "input[name=\"pack_id\"][value=\"1\"]").click()
    assert len(self.driver.find_elements(By.CSS_SELECTOR, ".packmgmt-packinvalid button.btn-primaryrc:not([disabled])")) > 0
    self.driver.execute_script("//SETDESC:Assert pack can be marked as valid")
    self.driver.find_element(By.CSS_SELECTOR, ".packmgmt-packinvalid button.btn-primaryrc").send_keys("SAVESCREENSHOT")
    self.driver.find_element(By.CSS_SELECTOR, "input[name=\"pack_id\"][value=\"1\"]").click()
    self.driver.find_element(By.CSS_SELECTOR, "input[name=\"pack_id\"][value=\"2\"]").click()
    assert len(self.driver.find_elements(By.CSS_SELECTOR, ".packmgmt-packinvalid button.btn-primaryrc:not([disabled])")) == 0
    self.driver.execute_script("//SETDESC:Assert pack can not be marked as invalid")
    self.driver.find_element(By.CSS_SELECTOR, ".packmgmt-packinvalid button.btn-primaryrc").send_keys("SAVESCREENSHOT")
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"prefix=pack_management\"][href*=\"page=configure\"]").click()
