...
class Test_05_Assign_pack_form_submit_expiry:
  ...
  def test_05_Assign_pack_form_submit_expiry(self):
    ...
    self.driver.find_element(By.NAME, "cat_id").send_keys("packs5")
    ...
    self.driver.find_element(By.XPATH, "//td//span[contains(.,'packs5')]").send_keys("SAVESCREENSHOT")
    ...
    self.driver.execute_script("//SAVEDESC:Perform upload of CSV data (with pack expiry date in past)")
    ...
    self.driver.execute_script("//SAVEDESC:Perform upload of CSV data (with pack expiry date in future)")
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"DataEntry/record_status_dashboard.php\"]").click()
    self.driver.execute_script("//SETDESC:Click \"Visit Lab Data\"")
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"page=visit_lab_data\"]").click()
    self.driver.execute_script("//SAVEDESC:Save form")
