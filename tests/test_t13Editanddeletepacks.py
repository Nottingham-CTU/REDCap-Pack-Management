...
class TestT13Editanddeletepacks():
  ...
  def test_t13Editanddeletepacks(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, "input[type=\"submit\"]").click()
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.ID, "south")))
    elements = self.driver.find_elements(By.CSS_SELECTOR, "a[href*=\"page=configure_edit\"][href*=\"cat_id=packs13\"]")
    assert len(elements) > 0
    ...
    elements = self.driver.find_elements(By.CSS_SELECTOR, "a[href*=\"page=packs_edit\"]")
    assert len(elements) > 0
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"page=packs_edit\"][href*=\"pack_id=2\"]").click()
    elements = self.driver.find_elements(By.CSS_SELECTOR, "input[name=\"f_test\"][value=\"22\"]")
    assert len(elements) > 0
    ...
    assert len(elements) > 0
    elements = self.driver.find_elements(By.CSS_SELECTOR, "input[name=\"f_test\"][value=\"1234\"]")
    assert len(elements) > 0
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"page=packs_list\"][href*=\"cat_id=packs13\"]").click()
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.ID, "south")))
    elements = self.driver.find_elements(By.CSS_SELECTOR, "a[href*=\"page=packs_edit\"][href*=\"pack_id=3\"]")
    assert len(elements) == 0
    ...
    dropdown.find_element(By.XPATH, "//option[. = 'PackEdit']").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, "[role=\"dialog\"] .ok-button").click()
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.ID, "south")))
    elements = self.driver.find_elements(By.CSS_SELECTOR, "a[href*=\"page=packs_edit\"][href*=\"pack_id=2\"]")
    assert len(elements) == 0
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"action=myprojects\"]").click()
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"logout=1\"]").click()
