...
class Test_03_Assign_pack_form_submit_DAG:
  ...
  def test_03_Assign_pack_form_submit_DAG(self):
    ...
    self.driver.find_element(By.NAME, "cat_id").send_keys("packs3")
    ...
    self.driver.find_element(By.XPATH, "//td//span[contains(.,'packs3')]").send_keys("SAVESCREENSHOT")
    ...
    self.driver.execute_script("//SETDESC:Assert packs issued successfully")
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.ID, "south")))
    assert len(self.driver.find_elements(By.CSS_SELECTOR, ".mod-packmgmt-okmsg")) > 0
    self.driver.execute_script("//SETDESC:Assert packs acknowledged successfully")
    self.driver.find_element(By.CSS_SELECTOR, ".mod-packmgmt-okmsg").send_keys("SAVESCREENSHOT")
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"DataEntry/record_status_dashboard.php\"]").click()
    self.driver.execute_script("//SETDESC:Click \"Visit Lab Data\"")
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"page=visit_lab_data\"]").click()
